...
const PlannerLayout: React.FC<PlannerLayoutProps> = ({ children }) => {
  return (
    ...
    >
      {/* Textura de Olas (Igual que en AuthLayout) */}
      <div 
      ...
      {/* Sidebar - z-index ensures it sits above waves */}
      <PlannerSidebar />
      ...
      {/* Optional Right Aside (e.g. for widgets, stats, quick actions) */}
      <aside className="w-80 bg-slate-900/40 backdrop-blur-md border-l border-slate-700/50 shadow-xl h-screen sticky top-0 hidden lg:block p-6 z-10">
        ...
        <button className="w-full py-3 px-4 bg-teal-500 hover:bg-teal-400 text-slate-900 font-bold rounded-xl transition-all shadow-md hover:shadow-teal-500/25 hover:-translate-y-0.5 flex justify-center items-center gap-2 cursor-pointer">
